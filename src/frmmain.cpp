...
//    ui->scrollArea->updateMinimumWidth();
    ...
    ui->cmdHome->setBackColor(QColor(153, 180, 209));
    ui->cmdTouch->setBackColor(ui->cmdHome->backColor());
    ui->cmdZeroXY->setBackColor(ui->cmdHome->backColor());
    ui->cmdZeroZ->setBackColor(ui->cmdHome->backColor());
    ui->cmdRestoreOrigin->setBackColor(ui->cmdHome->backColor());
    ui->cmdSafePosition->setBackColor(ui->cmdHome->backColor());
    ui->cmdReset->setBackColor(ui->cmdHome->backColor());
    ui->cmdUnlock->setBackColor(ui->cmdHome->backColor());
    ui->cmdSpindle->setBackColor(QColor(255, 94, 87));

    ui->cmdUser0->setBackColor(QColor(131,186,97));
    ui->cmdUser1->setBackColor(ui->cmdUser0->backColor());
    ui->cmdUser2->setBackColor(ui->cmdUser0->backColor());
    ui->cmdUser3->setBackColor(ui->cmdUser0->backColor());

    ui->cmdHeightMapCreate->setBackColor(ui->cmdXMinus->backColor());
    ui->cmdHeightMapLoad->setBackColor(ui->cmdXMinus->backColor());
    ui->cmdHeightMapMode->setBackColor(ui->cmdXMinus->backColor());
    ui->cmdHeightMapBorderAuto->setBackColor(ui->cmdXMinus->backColor());
    ...
    ui->dockDevice->setVisible(true);
    ui->dockVisualizer->setVisible(true);
    ui->dockModification->setVisible(true);
